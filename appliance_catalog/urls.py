...
urlpatterns = patterns(
    ...
    url(r'^(?P<pk>\d+)/edit/image/$', 'app_edit_image', name='app_edit_image'),
    url(r'^(?P<pk>\d+)/delete/$', ApplianceDeleteView.as_view(), name='app_delete'),
    url(r'^create/$', 'app_create', name='app_create'),
    url(r'^create/image/$', 'app_create_image', name='app_create_image'),
    ...
    url(r'^api/appliances/appliance_id/(?P<appliance_id>[0-9a-f-]+)/$', 'get_appliance_by_id', name='get_appliance_by_id'),
