...
def app_detail(request, pk):
	...
	return render(request, 'appliance_catalog/detail.html', {'appliance': appliance, 'keywords': keywords})
...
def app_edit(request, pk):
	...
	if request.method == 'POST':
		...
		if form.is_valid():
			logger.debug('Applicate edit form is valid. Updating this appliance...')
