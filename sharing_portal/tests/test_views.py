...
class UploadViewTest(TestCase):
    def test_no_doi_get(self):
        ...
        error_message = (
            "No doi was provided. To upload to the portal,"
...
class UploadArtifactTest(TestCase):
    ...
    def test_non_dev_success(self):
        ...
        self.assertEqual(
            artifact.title,
            ("Modelling and Simulation of Water" " Networks based on Loop Method"),
        )
        self.assertIn("Simulator algorithm for water networks", artifact.description)
        self.assertEqual(len(list(artifact.authors.all())), 1)
