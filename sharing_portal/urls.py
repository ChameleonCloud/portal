...
urlpatterns = [
    ...
    re_path(r'^project/(?P<charge_code>[\w-]+)$', views.index_project, name='index_project'),

    re_path(r'^(?P<pk>\d+)$', views.artifact, name='detail'),
    re_path(r'^(?P<pk>\d+)/launch$', views.launch, name='launch'),
    re_path(r'^(?P<pk>\d+)/version/(?P<version_idx>\d+)$', views.artifact, name='detail_version'),
    re_path(r'^(?P<pk>\d+)/version/(?P<version_idx>\d+)/launch$', views.launch, name='launch_version'),
